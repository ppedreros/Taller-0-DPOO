...
public class ConsolaOlimpicos
{
	...
	/**
	 * Este método le pide al usuario el nombre de un atleta para buscarlo en los datos e imprimir el pa�s al
	 * que representa
	 */
	private void ejecutarPaisAtleta()
	{
		String NombreAtleta = input("Ingrese el nombre de un atleta: "); 
		Atleta atleta = calculadora.buscarAtleta(NombreAtleta);
		System.out.println("El atleta representa a " + atleta.darPais().darNombre());
	}
